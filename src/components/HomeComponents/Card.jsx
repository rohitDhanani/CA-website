...
const Card = ({icon:Icon = FaMoneyCheckDollar,title,description,bg='bg-[#F0F9FF]',height='72',width='60'}) => {
  return (
    <div style={{minWidth:`${width/4}rem`,maxWidth:`${width/4}rem`,minHeight:`${height/4}rem`,}} className={`${bg} p-2 rounded max-w-${width} min-w-${width} min-h-${height} shadow transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300`}>
        <NavLink to={'/contact'}>
