...
const HeroSec = () => {
  ...
  return (
    <div ref={targetRef} className="bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('/img3.jpg')] bg-cover bg-center z-0 h-screen flex flex-col justify-center gap-10 items-center text-white">
